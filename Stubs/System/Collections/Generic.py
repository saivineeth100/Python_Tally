...
class Comparer(object, IComparer, IComparer[T]):
    ...
    def Compare(self, x, y):
        ...
        Compare(self: Comparer[T], x: T, y: T) -> int
            ...
            When overridden in a derived class, performs a comparison of two objects of the same type and returns a value indicating whether 
...
class Dictionary(object, IDictionary[TKey, TValue], ICollection[KeyValuePair[TKey, TValue]], IEnumerable[KeyValuePair[TKey, TValue]], IEnumerable, IDictionary, ICollection, IReadOnlyDictionary[TKey, TValue], IReadOnlyCollection[KeyValuePair[TKey, TValue]], ISerializable, IDeserializationCallback):
    ...
    def ContainsKey(self, key):
        ...
        ContainsKey(self: Dictionary[TKey, TValue], key: TKey) -> bool
            ...
            Returns: ue if the System.Collections.Generic.Dictionary contains an element with the specified key; otherwise, lse.
        """
        pass
    ...
    def GetObjectData(self, info, context):
        ...
        GetObjectData(self: Dictionary[TKey, TValue], info: SerializationInfo, context: StreamingContext)
            ...
            context: A System.Runtime.Serialization.StreamingContext structure that contains the source and destination of the serialized stream 
             associated with the System.Collections.Generic.Dictionary instance.
        """
        pass
    ...
    def Remove(self, key):
        ...
        Remove(self: Dictionary[TKey, TValue], key: TKey) -> bool
            ...
            Returns: ue if the element is successfully found and removed; otherwise, lse.  This method returns lse if key is not found in the 
...
class EqualityComparer(object, IEqualityComparer, IEqualityComparer[T]):
    ...
    def GetHashCode(self, obj=None):
        ...
        GetHashCode(self: EqualityComparer[T], obj: T) -> int
            ...
            When overridden in a derived class, serves as a hash function for the specified object for hashing algorithms and data 
...
class ICollection(IEnumerable[T], IEnumerable):
    ...
    def Remove(self, item):
        ...
        Remove(self: ICollection[T], item: T) -> bool
            ...
            Returns: ue if item was successfully removed from the System.Collections.Generic.ICollection; otherwise, lse. This method also returns 
             lse if item is not found in the original System.Collections.Generic.ICollection.
        """
        pass
...
class IDictionary(ICollection[KeyValuePair[TKey, TValue]], IEnumerable[KeyValuePair[TKey, TValue]], IEnumerable):
    ...
    def Remove(self, key):
        ...
        Remove(self: IDictionary[TKey, TValue], key: TKey) -> bool
            ...
            key: The key of the element to remove.
            Returns: ue if the element is successfully removed; otherwise, lse.  This method also returns lse if key was not found in the original 
...
class ISet(ICollection[T], IEnumerable[T], IEnumerable):
    ...
    def Add(self, item):
        ...
        Add(self: ISet[T], item: T) -> bool
            ...
            Returns: ue if the element is added to the set; lse if the element is already in the set.
        """
        pass
    ...
    def UnionWith(self, other):
        ...
        UnionWith(self: ISet[T], other: IEnumerable[T])
            Modifies the current set so that it contains all elements that are present in the current set, in the specified collection, or 
             in both.
...
class KeyValuePair(object):
    ...
    def ToString(self):
        ...
        ToString(self: KeyValuePair[TKey, TValue]) -> str
            ...
            Returns a string representation of the System.Collections.Generic.KeyValuePair, using the string representations of the key and 
             value.
        
            Returns: A string representation of the System.Collections.Generic.KeyValuePair, which includes the string representations of the key and 
             value.
        """
        pass
...
class LinkedList(object, ICollection[T], IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T], ISerializable, IDeserializationCallback):
    ...
    def AddAfter(self, node, *__args):
        ...
        AddAfter(self: LinkedList[T], node: LinkedListNode[T], value: T) -> LinkedListNode[T]
            ...
            node: The System.Collections.Generic.LinkedListNode after which to insert a new System.Collections.Generic.LinkedListNode containing 
             value.
    ...
    def AddBefore(self, node, *__args):
        ...
        AddBefore(self: LinkedList[T], node: LinkedListNode[T], value: T) -> LinkedListNode[T]
            ...
            node: The System.Collections.Generic.LinkedListNode before which to insert a new System.Collections.Generic.LinkedListNode containing 
             value.
    ...
    def Contains(self, value):
        ...
        Contains(self: LinkedList[T], value: T) -> bool
            ...
            value: The value to locate in the System.Collections.Generic.LinkedList. The value can be ll for reference types.
            Returns: ue if value is found in the System.Collections.Generic.LinkedList; otherwise, lse.
        """
        pass
    ...
    def GetObjectData(self, info, context):
        ...
        GetObjectData(self: LinkedList[T], info: SerializationInfo, context: StreamingContext)
            ...
            context: A System.Runtime.Serialization.StreamingContext object that contains the source and destination of the serialized stream 
             associated with the System.Collections.Generic.LinkedList instance.
        """
        pass
    ...
    def Remove(self, *__args):
        ...
        Remove(self: LinkedList[T], value: T) -> bool
            ...
            Returns: ue if the element containing value is successfully removed; otherwise, lse.  This method also returns lse if value was not found 
             in the original System.Collections.Generic.LinkedList.
...
class List(object, IList[T], ICollection[T], IEnumerable[T], IEnumerable, IList, ICollection, IReadOnlyList[T], IReadOnlyCollection[T]):
    ...
    def Add(self, item):
        ...
        Add(self: List[T], item: T)
            ...
            item: The object to be added to the end of the System.Collections.Generic.List. The value can be ll for reference types.
        """
        pass
    ...
    def AddRange(self, collection):
        ...
        AddRange(self: List[T], collection: IEnumerable[T])
            ...
            collection: The collection whose elements should be added to the end of the System.Collections.Generic.List. The collection itself cannot be 
             ll, but it can contain elements that are ll, if type T is a reference type.
        """
        pass
    ...
    def BinarySearch(self, *__args):
        ...
        BinarySearch(self: List[T], index: int, count: int, item: T, comparer: IComparer[T]) -> int
            ...
            Searches a range of elements in the sorted System.Collections.Generic.List for an element using the specified comparer and 
            ...
            comparer: The System.Collections.Generic.IComparer implementation to use when comparing elements, or ll to use the default comparer 
             System.Collections.Generic.Comparer.
        
            Returns: The zero-based index of item in the sorted System.Collections.Generic.List, if item is found; otherwise, a negative number that 
             is the bitwise complement of the index of the next element that is larger than item or, if there is no larger element, the 
             bitwise complement of System.Collections.Generic.List.
        
        BinarySearch(self: List[T], item: T) -> int
        
            Searches the entire sorted System.Collections.Generic.List for an element using the default comparer and returns the zero-based 
        ...
        BinarySearch(self: List[T], item: T, comparer: IComparer[T]) -> int
            ...
            Searches the entire sorted System.Collections.Generic.List for an element using the specified comparer and returns the 
         ...
         -or-  
         ll to use the default 
             comparer System.Collections.Generic.Comparer.
    ...
    def Contains(self, item):
        ...
        Contains(self: List[T], item: T) -> bool
            ...
            Returns: ue if item is found in the System.Collections.Generic.List; otherwise, lse.
        """
        pass
    ...
    def Exists(self, match):
        ...
        Exists(self: List[T], match: Predicate[T]) -> bool
            ...
            Determines whether the System.Collections.Generic.List contains elements that match the conditions defined by the specified 
             predicate.
        
        
            match: The System.Predicate delegate that defines the conditions of the elements to search for.
            Returns: ue if the System.Collections.Generic.List contains one or more elements that match the conditions defined by the specified 
             predicate; otherwise, lse.
        """
        pass
    ...
    def Find(self, match):
        ...
        Find(self: List[T], match: Predicate[T]) -> T
            ...
            Returns: The first element that matches the conditions defined by the specified predicate, if found; otherwise, the default value for 
             type T.
        """
        pass
    ...
    def FindAll(self, match):
        ...
        FindAll(self: List[T], match: Predicate[T]) -> List[T]
            ...
            match: The System.Predicate delegate that defines the conditions of the elements to search for.
            Returns: A System.Collections.Generic.List containing all the elements that match the conditions defined by the specified predicate, if 
             found; otherwise, an empty System.Collections.Generic.List.
        """
        pass
    ...
    def FindIndex(self, *__args):
        ...
        FindIndex(self: List[T], startIndex: int, match: Predicate[T]) -> int
            ...
            Searches for an element that matches the conditions defined by the specified predicate, and returns the zero-based index of the 
             first occurrence within the range of elements in the System.Collections.Generic.List that extends from the specified index to 
             the last element.
        ...
        FindIndex(self: List[T], startIndex: int, count: int, match: Predicate[T]) -> int
            ...
            Searches for an element that matches the conditions defined by the specified predicate, and returns the zero-based index of the 
             first occurrence within the range of elements in the System.Collections.Generic.List that starts at the specified index and 
    ...
    def FindLastIndex(self, *__args):
        ...
        FindLastIndex(self: List[T], match: Predicate[T]) -> int
            ...
            Searches for an element that matches the conditions defined by the specified predicate, and returns the zero-based index of the 
             last occurrence within the entire System.Collections.Generic.List.
        ...
        FindLastIndex(self: List[T], startIndex: int, match: Predicate[T]) -> int
            ...
            Searches for an element that matches the conditions defined by the specified predicate, and returns the zero-based index of the 
             last occurrence within the range of elements in the System.Collections.Generic.List that extends from the first element to the 
             specified index.
        ...
        FindLastIndex(self: List[T], startIndex: int, count: int, match: Predicate[T]) -> int
            ...
            Searches for an element that matches the conditions defined by the specified predicate, and returns the zero-based index of the 
             last occurrence within the range of elements in the System.Collections.Generic.List that contains the specified number of 
    ...
    def IndexOf(self, item, index=None, count=None):
        ...
        IndexOf(self: List[T], item: T) -> int
            ...
            item: The object to locate in the System.Collections.Generic.List. The value can be ll for reference types.
            Returns: The zero-based index of the first occurrence of item within the entire System.Collections.Generic.List, if found; otherwise, -1.
        IndexOf(self: List[T], item: T, index: int) -> int
            ...
            Returns: The zero-based index of the first occurrence of item within the range of elements in the System.Collections.Generic.List that 
        ...
        IndexOf(self: List[T], item: T, index: int, count: int) -> int
            ...
            count: The number of elements in the section to search.
            Returns: The zero-based index of the first occurrence of item within the range of elements in the System.Collections.Generic.List that 
             starts at index and contains count number of elements, if found; otherwise, -1.
        """
        pass
    ...
    def InsertRange(self, index, collection):
        ...
        InsertRange(self: List[T], index: int, collection: IEnumerable[T])
            ...
            collection: The collection whose elements should be inserted into the System.Collections.Generic.List. The collection itself cannot be ll, 
             but it can contain elements that are ll, if type T is a reference type.
        """
        pass
    ...
    def LastIndexOf(self, item, index=None, count=None):
        ...
        LastIndexOf(self: List[T], item: T) -> int
            ...
            item: The object to locate in the System.Collections.Generic.List. The value can be ll for reference types.
            Returns: The zero-based index of the last occurrence of item within the entire the System.Collections.Generic.List, if found; otherwise, 
             -1.
        ...
        LastIndexOf(self: List[T], item: T, index: int) -> int
            ...
            Returns: The zero-based index of the last occurrence of item within the range of elements in the System.Collections.Generic.List that 
             extends from the first element to index, if found; otherwise, -1.
    ...
    def Remove(self, item):
        ...
        Remove(self: List[T], item: T) -> bool
            ...
            item: The object to remove from the System.Collections.Generic.List. The value can be ll for reference types.
            Returns: ue if item is successfully removed; otherwise, lse.  This method also returns lse if item was not found in the 
             System.Collections.Generic.List.
        """
        pass
    ...
    def TrimExcess(self):
        ...
        TrimExcess(self: List[T])
            Sets the capacity to the actual number of elements in the System.Collections.Generic.List, if that number is less than a 
             threshold value.
        """
        pass
    ...
    def TrueForAll(self, match):
        ...
        TrueForAll(self: List[T], match: Predicate[T]) -> bool
            ...
            Determines whether every element in the System.Collections.Generic.List matches the conditions defined by the specified 
             predicate.
        
        
            match: The System.Predicate delegate that defines the conditions to check against the elements.
            Returns: ue if every element in the System.Collections.Generic.List matches the conditions defined by the specified predicate; otherwise, 
             lse. If the list has no elements, the return value is ue.
        """
        pass
...
class Queue(object, IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T]):
    ...
    def TrimExcess(self):
        ...
        TrimExcess(self: Queue[T])
            Sets the capacity to the actual number of elements in the System.Collections.Generic.Queue, if that number is less than 90 
...
class SortedDictionary(object, IDictionary[TKey, TValue], ICollection[KeyValuePair[TKey, TValue]], IEnumerable[KeyValuePair[TKey, TValue]], IEnumerable, IDictionary, ICollection, IReadOnlyDictionary[TKey, TValue], IReadOnlyCollection[KeyValuePair[TKey, TValue]]):
    ...
    def ContainsKey(self, key):
        ...
        ContainsKey(self: SortedDictionary[TKey, TValue], key: TKey) -> bool
            ...
            Returns: ue if the System.Collections.Generic.SortedDictionary contains an element with the specified key; otherwise, lse.
        """
        pass
...
class SortedList(object, IDictionary[TKey, TValue], ICollection[KeyValuePair[TKey, TValue]], IEnumerable[KeyValuePair[TKey, TValue]], IEnumerable, IDictionary, ICollection, IReadOnlyDictionary[TKey, TValue], IReadOnlyCollection[KeyValuePair[TKey, TValue]]):
    ...
    def ContainsKey(self, key):
        ...
        ContainsKey(self: SortedList[TKey, TValue], key: TKey) -> bool
            ...
            Returns: ue if the System.Collections.Generic.SortedList contains an element with the specified key; otherwise, lse.
        """
        pass
    ...
    def GetEnumerator(self):
        ...
        GetEnumerator(self: SortedList[TKey, TValue]) -> IEnumerator[KeyValuePair[TKey, TValue]]
            ...
            Returns: An System.Collections.Generic.IEnumerator of type System.Collections.Generic.KeyValuePair for the 
    ...
    def IndexOfValue(self, value):
        ...
        IndexOfValue(self: SortedList[TKey, TValue], value: TValue) -> int
            ...
            value: The value to locate in the System.Collections.Generic.SortedList.  The value can be ll for reference types.
            Returns: The zero-based index of the first occurrence of value within the entire System.Collections.Generic.SortedList, if found; 
             otherwise, -1.
        """
        pass
    ...
    def TrimExcess(self):
        ...
        TrimExcess(self: SortedList[TKey, TValue])
            Sets the capacity to the actual number of elements in the System.Collections.Generic.SortedList, if that number is less than 90 
             percent of current capacity.
        """
        pass
...
class SortedSet(object, ISet[T], ICollection[T], IEnumerable[T], IEnumerable, ICollection, ISerializable, IDeserializationCallback, IReadOnlyCollection[T]):
    ...
    def Add(self, item):
        ...
        Add(self: SortedSet[T], item: T) -> bool
            ...
            item: The element to add to the set.
            Returns: ue if item is added to the set; otherwise, lse.
        """
        pass
    ...
    def CreateSetComparer(memberEqualityComparer=None):
        ...
        CreateSetComparer(memberEqualityComparer: IEqualityComparer[T]) -> IEqualityComparer[SortedSet[T]]
            ...
            Returns an System.Collections.IEqualityComparer object, according to a specified comparer, that can be used to create a 
    ...
    def GetObjectData(self, *args): #cannot find CLR method
        ...
        GetObjectData(self: SortedSet[T], info: SerializationInfo, context: StreamingContext)
            Implements the System.Runtime.Serialization.ISerializable interface and returns the data that you must have to serialize a 
             System.Collections.Generic.SortedSet object.
        
        
            info: A System.Runtime.Serialization.SerializationInfo object that contains the information that is required to serialize the 
             System.Collections.Generic.SortedSet object.
        
            context: A System.Runtime.Serialization.StreamingContext structure that contains the source and destination of the serialized stream 
             associated with the System.Collections.Generic.SortedSet object.
        """
        pass
    ...
    def IntersectWith(self, other):
        ...
        IntersectWith(self: SortedSet[T], other: IEnumerable[T])
            Modifies the current System.Collections.Generic.SortedSet object so that it contains only elements that are also in a specified 
             collection.
    ...
    def IsProperSubsetOf(self, other):
        ...
        IsProperSubsetOf(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the System.Collections.Generic.SortedSet object is a proper subset of other; otherwise, lse.
        """
        pass
    ...
    def IsProperSupersetOf(self, other):
        ...
        IsProperSupersetOf(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the System.Collections.Generic.SortedSet object is a proper superset of other; otherwise, lse.
        """
        pass
    ...
    def IsSubsetOf(self, other):
        ...
        IsSubsetOf(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the current System.Collections.Generic.SortedSet object is a subset of other; otherwise, lse.
        """
        pass
    ...
    def IsSupersetOf(self, other):
        ...
        IsSupersetOf(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the System.Collections.Generic.SortedSet object is a superset of other; otherwise, lse.
        """
        pass
    ...
    def Overlaps(self, other):
        ...
        Overlaps(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the System.Collections.Generic.SortedSet object and other share at least one common element; otherwise, lse.
        """
        pass
    ...
    def SetEquals(self, other):
        ...
        SetEquals(self: SortedSet[T], other: IEnumerable[T]) -> bool
            ...
            Determines whether the current System.Collections.Generic.SortedSet object and the specified collection contain the same 
             elements.
        
        
            other: The collection to compare to the current System.Collections.Generic.SortedSet object.
            Returns: ue if the current System.Collections.Generic.SortedSet object is equal to other; otherwise, false.
        """
        pass
    ...
    def SymmetricExceptWith(self, other):
        ...
        SymmetricExceptWith(self: SortedSet[T], other: IEnumerable[T])
            Modifies the current System.Collections.Generic.SortedSet object so that it contains only elements that are present either in 
             the current object or in the specified collection, but not both.
    ...
    def UnionWith(self, other):
        ...
        UnionWith(self: SortedSet[T], other: IEnumerable[T])
            Modifies the current System.Collections.Generic.SortedSet object so that it contains all elements that are present in either the 
             current object or the specified collection.
...
class Stack(object, IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T]):
    ...
    def TrimExcess(self):
        ...
        TrimExcess(self: Stack[T])
            Sets the capacity to the actual number of elements in the System.Collections.Generic.Stack, if that number is less than 90 
             percent of current capacity.
        """
        pass
