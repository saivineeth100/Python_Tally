...
class BlockingCollection(object, IEnumerable[T], IEnumerable, ICollection, IDisposable, IReadOnlyCollection[T]):
    ...
    def TryAdd(self, item, *__args):
        ...
        TryAdd(self: BlockingCollection[T], item: T) -> bool
            ...
            Returns: ue if item could be added; otherwise, lse. If the item is a duplicate, and the underlying collection does not accept duplicate 
        ...
        TryAdd(self: BlockingCollection[T], item: T, timeout: TimeSpan) -> bool
            ...
            item: The item to be added to the collection.
            timeout: A System.TimeSpan that represents the number of milliseconds to wait, or a System.TimeSpan that represents -1 milliseconds to 
             wait indefinitely.
        ...
        TryAdd(self: BlockingCollection[T], item: T, millisecondsTimeout: int) -> bool
            ...
            Returns: true if the item could be added to the collection within the specified time; otherwise, false. If the item is a duplicate, and 
        ...
        TryAdd(self: BlockingCollection[T], item: T, millisecondsTimeout: int, cancellationToken: CancellationToken) -> bool
            ...
            Tries to add the specified item to the System.Collections.Concurrent.BlockingCollection within the specified time period, while 
...
class ConcurrentBag(object, IProducerConsumerCollection[T], IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T]):
    ...
    def Add(self, item):
        ...
        Add(self: ConcurrentBag[T], item: T)
            ...
            item: The object to be added to the System.Collections.Concurrent.ConcurrentBag. The value can be a null reference (Nothing in Visual 
...
class ConcurrentDictionary(object, IDictionary[TKey, TValue], ICollection[KeyValuePair[TKey, TValue]], IEnumerable[KeyValuePair[TKey, TValue]], IEnumerable, IDictionary, ICollection, IReadOnlyDictionary[TKey, TValue], IReadOnlyCollection[KeyValuePair[TKey, TValue]]):
    ...
    def ContainsKey(self, key):
        ...
        ContainsKey(self: ConcurrentDictionary[TKey, TValue], key: TKey) -> bool
            ...
            Returns: ue if the System.Collections.Concurrent.ConcurrentDictionary contains an element with the specified key; otherwise, lse.
        """
        pass
    ...
    def GetOrAdd(self, key, *__args):
        ...
        GetOrAdd(self: ConcurrentDictionary[TKey, TValue], key: TKey, valueFactory: Func[TKey, TValue]) -> TValue
            ...
            Adds a key/value pair to the System.Collections.Concurrent.ConcurrentDictionary by using the specified function if the key does 
            ...
            Returns: The value for the key. This will be either the existing value for the key if the key is already in the dictionary, or the new 
             value if the key was not in the dictionary.
        
        GetOrAdd(self: ConcurrentDictionary[TKey, TValue], key: TKey, value: TValue) -> TValue
        
            Adds a key/value pair to the System.Collections.Concurrent.ConcurrentDictionary if the key does not already exist. Returns the 
    ...
    def TryAdd(self, key, value):
        ...
        TryAdd(self: ConcurrentDictionary[TKey, TValue], key: TKey, value: TValue) -> bool
            ...
            Returns: ue if the key/value pair was added to the System.Collections.Concurrent.ConcurrentDictionary successfully; lse if the key 
             already exists.
        """
        pass
    ...
    def TryUpdate(self, key, newValue, comparisonValue):
        ...
        TryUpdate(self: ConcurrentDictionary[TKey, TValue], key: TKey, newValue: TValue, comparisonValue: TValue) -> bool
            ...
            key: The key of the value that is compared with comparisonValue and possibly replaced.
            ...
            comparisonValue: The value that is compared with the value of the element that has the specified key.
...
class ConcurrentQueue(object, IProducerConsumerCollection[T], IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T]):
    ...
    def Enqueue(self, item):
        ...
        Enqueue(self: ConcurrentQueue[T], item: T)
            ...
            item: The object to add to the end of the System.Collections.Concurrent.ConcurrentQueue. The value can be a null reference (Nothing in 
...
class ConcurrentStack(object, IProducerConsumerCollection[T], IEnumerable[T], IEnumerable, ICollection, IReadOnlyCollection[T]):
    ...
    def Push(self, item):
        ...
        Push(self: ConcurrentStack[T], item: T)
            ...
            item: The object to push onto the System.Collections.Concurrent.ConcurrentStack. The value can be a null reference (Nothing in Visual 
             Basic) for reference types.
        """
        pass
