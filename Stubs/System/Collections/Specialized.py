...
class CollectionsUtil(object):
    ...
    def CreateCaseInsensitiveHashtable(*__args):
        ...
        CreateCaseInsensitiveHashtable(d: IDictionary) -> Hashtable
            ...
            Copies the entries from the specified dictionary to a new case-insensitive instance of the System.Collections.Hashtable class 
             with the same initial capacity as the number of entries copied.
        
        
            d: The System.Collections.IDictionary to copy to a new case-insensitive System.Collections.Hashtable.
            Returns: A new case-insensitive instance of the System.Collections.Hashtable class containing the entries from the specified 
...
class HybridDictionary(object, IDictionary, ICollection, IEnumerable):
    ...
    def Contains(self, key):
        ...
        Contains(self: HybridDictionary, key: object) -> bool
            ...
            Returns: ue if the System.Collections.Specialized.HybridDictionary contains an entry with the specified key; otherwise, lse.
        """
        pass
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: HybridDictionary, array: Array, index: int)
            Copies the System.Collections.Specialized.HybridDictionary entries to a one-dimensional System.Array instance at the specified 
             index.
...
class ListDictionary(object, IDictionary, ICollection, IEnumerable):
    ...
    def Contains(self, key):
        ...
        Contains(self: ListDictionary, key: object) -> bool
            ...
            Returns: ue if the System.Collections.Specialized.ListDictionary contains an entry with the specified key; otherwise, lse.
        """
        pass
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: ListDictionary, array: Array, index: int)
            Copies the System.Collections.Specialized.ListDictionary entries to a one-dimensional System.Array instance at the specified 
             index.
...
class NameObjectCollectionBase(object, ICollection, IEnumerable, ISerializable, IDeserializationCallback):
    ...
    def BaseHasKeys(self, *args): #cannot find CLR method
        ...
        BaseHasKeys(self: NameObjectCollectionBase) -> bool
            ...
            Gets a value indicating whether the System.Collections.Specialized.NameObjectCollectionBase instance contains entries whose keys 
             are not ll.
        
            Returns: ue if the System.Collections.Specialized.NameObjectCollectionBase instance contains entries whose keys are not ll; otherwise, 
             lse.
        """
        pass
    ...
    def BaseSet(self, *args): #cannot find CLR method
        ...
        BaseSet(self: NameObjectCollectionBase, name: str, value: object)
            Sets the value of the first entry with the specified key in the System.Collections.Specialized.NameObjectCollectionBase 
             instance, if found; otherwise, adds an entry with the specified key and value into the 
             System.Collections.Specialized.NameObjectCollectionBase instance.
    ...
    def GetObjectData(self, info, context):
        ...
        GetObjectData(self: NameObjectCollectionBase, info: SerializationInfo, context: StreamingContext)
            ...
            context: A System.Runtime.Serialization.StreamingContext object that contains the source and destination of the serialized stream 
             associated with the System.Collections.Specialized.NameObjectCollectionBase instance.
        """
        pass
...
class NameValueCollection(NameObjectCollectionBase, ICollection, IEnumerable, ISerializable, IDeserializationCallback):
    ...
    def Add(self, *__args):
        ...
        Add(self: NameValueCollection, c: NameValueCollection)
            Copies the entries in the specified System.Collections.Specialized.NameValueCollection to the current 
    ...
    def CopyTo(self, dest, index):
        ...
        CopyTo(self: NameValueCollection, dest: Array, index: int)
            Copies the entire System.Collections.Specialized.NameValueCollection to a compatible one-dimensional System.Array, starting at 
            ...
            dest: The one-dimensional System.Array that is the destination of the elements copied from 
             System.Collections.Specialized.NameValueCollection. The System.Array must have zero-based indexing.
    ...
    def Get(self, *__args):
        ...
        Get(self: NameValueCollection, name: str) -> str
            ...
            Gets the values associated with the specified key from the System.Collections.Specialized.NameValueCollection combined into one 
            ...
            Returns: A System.String that contains a comma-separated list of the values associated with the specified key from the 
             System.Collections.Specialized.NameValueCollection, if found; otherwise, ll.
        
        Get(self: NameValueCollection, index: int) -> str
        
            Gets the values at the specified index of the System.Collections.Specialized.NameValueCollection combined into one 
             comma-separated list.
    ...
    def GetKey(self, index):
        ...
        GetKey(self: NameValueCollection, index: int) -> str
            ...
            Returns: A System.String that contains the key at the specified index of the System.Collections.Specialized.NameValueCollection, if 
             found; otherwise, ll.
        """
        pass
    ...
    def GetValues(self, *__args):
        ...
        GetValues(self: NameValueCollection, index: int) -> Array[str]
            ...
            index: The zero-based index of the entry that contains the values to get from the collection.
            Returns: A System.String array that contains the values at the specified index of the System.Collections.Specialized.NameValueCollection, 
...
class NotifyCollectionChangedEventHandler(MulticastDelegate, ICloneable, ISerializable):
    ...
    def DynamicInvokeImpl(self, *args): #cannot find CLR method
        ...
        DynamicInvokeImpl(self: Delegate, args: Array[object]) -> object
         ...
         -or-  
         ll, if the 
             method represented by the current delegate does not require arguments.
    ...
    def RemoveImpl(self, *args): #cannot find CLR method
        ...
        RemoveImpl(self: MulticastDelegate, value: Delegate) -> Delegate
            ...
            Returns: If value is found in the invocation list for this instance, then a new System.Delegate without value in its invocation list; 
             otherwise, this instance with its original invocation list.
        """
        pass
...
class OrderedDictionary(object, IOrderedDictionary, IDictionary, ICollection, IEnumerable, ISerializable, IDeserializationCallback):
    ...
    def Add(self, key, value):
        ...
        Add(self: OrderedDictionary, key: object, value: object)
            Adds an entry with the specified key and value into the System.Collections.Specialized.OrderedDictionary collection with the 
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: OrderedDictionary, array: Array, index: int)
            Copies the System.Collections.Specialized.OrderedDictionary elements to a one-dimensional System.Array object at the specified 
             index.
    ...
    def GetObjectData(self, info, context):
        ...
        GetObjectData(self: OrderedDictionary, info: SerializationInfo, context: StreamingContext)
            ...
            context: A System.Runtime.Serialization.StreamingContext object containing the source and destination of the serialized stream associated 
             with the System.Collections.Specialized.OrderedDictionary.
        """
        pass
    ...
    def Insert(self, index, key, value):
        ...
        Insert(self: OrderedDictionary, index: int, key: object, value: object)
            Inserts a new entry into the System.Collections.Specialized.OrderedDictionary collection with the specified key and value at the 
             specified index.
    ...
    def OnDeserialization(self, *args): #cannot find CLR method
        ...
        OnDeserialization(self: OrderedDictionary, sender: object)
            Implements the System.Runtime.Serialization.ISerializable interface and is called back by the deserialization event when 
             deserialization is complete.
...
class StringCollection(object, IList, ICollection, IEnumerable):
    ...
    def Add(self, value):
        ...
        Add(self: StringCollection, value: str) -> int
            ...
            value: The string to add to the end of the System.Collections.Specialized.StringCollection. The value can be ll.
    ...
    def AddRange(self, value):
        ...
        AddRange(self: StringCollection, value: Array[str])
            ...
            value: An array of strings to add to the end of the System.Collections.Specialized.StringCollection. The array itself can not be ll but 
             it can contain elements that are ll.
        """
        pass
    ...
    def Contains(self, value):
        ...
        Contains(self: StringCollection, value: str) -> bool
            ...
            value: The string to locate in the System.Collections.Specialized.StringCollection. The value can be ll.
            Returns: ue if value is found in the System.Collections.Specialized.StringCollection; otherwise, lse.
        """
        pass
    ...
    def CopyTo(self, array, index):
        ...
        CopyTo(self: StringCollection, array: Array[str], index: int)
            Copies the entire System.Collections.Specialized.StringCollection values to a one-dimensional array of strings, starting at the 
    ...
    def IndexOf(self, value):
        ...
        IndexOf(self: StringCollection, value: str) -> int
            ...
            value: The string to locate. The value can be ll.
            Returns: The zero-based index of the first occurrence of value in the System.Collections.Specialized.StringCollection, if found; 
             otherwise, -1.
        """
        pass
    ...
    def Insert(self, index, value):
        ...
        Insert(self: StringCollection, index: int, value: str)
            ...
            value: The string to insert. The value can be ll.
        """
        pass
    ...
    def Remove(self, value):
        ...
        Remove(self: StringCollection, value: str)
            ...
            value: The string to remove from the System.Collections.Specialized.StringCollection. The value can be ll.
        """
        pass
